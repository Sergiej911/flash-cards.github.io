(function(namespace) {
    ...
    namespace.ya.speechkit.initRecorder = function(initSuccess, initFail) {
        ...
        if (namespace.ya.speechkit.mediaDevices) {
            namespace.ya.speechkit.mediaDevices.getUserMedia({ audio: true }).then(
                function(stream) {
...
(function(namespace) {
    ...
    Recognizer.prototype = /** @lends Recognizer.prototype */ {
        ...
        start: function() {
            ...
            this.socket.onclose = function(event) {}.bind(this);
        },
        /**
    ...
    SpeechRecognition.prototype = /** @lends SpeechRecognition.prototype */ {
        ...
        _onstart: function() {
            ...
            if (!this.recorder) {
                ...
                if (this.options.vad) {
                    this.vad = new namespace.ya.speechkit.Vad({
...
(function(namespace) {
    ...
    Tts.prototype = /** @lends Tts.prototype */ {
        ...
        speak: function(text, options) {
            var opts = namespace.ya.speechkit._extend(
                namespace.ya.speechkit._extend({ text: text },
                    this.options),
                options);
            try {
            ...
            this.socket.onclose = function(event) {
                ...
                var wav_len = play_queue.reduce(function(prev, now, i, arr) {
                    return prev + now.byteLength; }, 0);
...
(function(namespace) {
    ...
    var WebAudioRecognition = function(options) {
        ...
        this.options = namespace.ya.speechkit._extend(
            namespace.ya.speechkit._extend(
                namespace.ya.speechkit._defaultOptions(),
                options), { format: namespace.ya.speechkit.FORMAT.PCM44 });
    };
